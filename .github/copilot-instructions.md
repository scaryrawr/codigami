...
When editing code, follow the repo's TDD expectation from `AGENTS.md`: add or update a focused Bun test before changing behavior, mock embedding providers and other external calls, and run the narrowest relevant validation before broader checks.
